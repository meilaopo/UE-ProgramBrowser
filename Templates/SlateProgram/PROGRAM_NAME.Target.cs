...
public class PROGRAM_NAMETarget : TargetRules
{
	public PROGRAM_NAMETarget(TargetInfo Target) : base(Target)
	{
		...
		// PROGRAM_NAME doesn't ever compile with the engine linked in
